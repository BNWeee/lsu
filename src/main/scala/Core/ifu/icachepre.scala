...
class icache_predecIO extends Bundle with Config  {
  val din = Input(Vec(8,UInt(16.W))) //
  val dout = Output(Vec(8,UInt(4.W)))
}
object pre_type {
...
class icache_predec extends Module with Config {
